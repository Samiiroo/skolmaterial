/*Uppgift 1
I script.js filen skapa en funktion min som tar en array som argument. Arrayen
innehåller objekt som värden och alla objekt har nyckeln value som är ett nummer.
 Funktionen ska returnera det objekt som har det lägsta värdet satt i sin value nyckel.
  Se filen för ett exempel.
/* Implement your solution here */

 function min(arr){
   let arrv = arr[0].value;
