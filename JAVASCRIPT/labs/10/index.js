...
//_____________________________________________________________________________________________
//=================== declare varaibles ======================================//
let nav        = document.querySelector("nav"); // main breeds lis
let section    = document.querySelector("section"); // sub breeds list
let main       = document.querySelector("main"); // breed-title, imgs + button
